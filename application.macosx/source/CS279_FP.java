...
public class CS279_FP extends PApplet {
...
public void setup()
{
  ...
  for (int i=0; i<dots.length; i++)
  {
    ...
    if (data[8].equals("female"))
      ...
      gender = "M";
    age = PApplet.parseInt(data[7]);
    bio = age + " " + gender + " " + data[10];
    mage = PApplet.parseInt(data[2]);
    if (mage > maxmage)
      maxmage = mage;
    mlocation = data[4];
...
public int [] getColor(String emotion)
{
  // yellow
...
public ArrayList wordWrap(String s, int maxWidth) 
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "CS279_FP" };
    if (passedArgs != null) {
